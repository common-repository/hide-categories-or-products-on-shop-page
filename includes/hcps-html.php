...
<div class="hcps_pro_features">
	<h1><?php _e('UNLOCK MORE FEATURES IN PRO VERSION', HCPS_TEXTDOMAIN); ?> <a href="https://wordpplugin.com/" target="_blank" class="hcps_pro_features_link">Please Click</a></h1>
	<ul class="hcps_pro_features_list">
		<li><?php _e('1- Select multiple categories', HCPS_TEXTDOMAIN)?></li>
		<li><?php _e('2- Hide categories/products and Show The 404 Page', HCPS_TEXTDOMAIN)?></li>
	</ul>
	<p><?php _e('If you have any suggestions for this plugin and add more features. <a href="https://wordpplugin.com/" target="_blank">Please Click</a>', HCPS_TEXTDOMAIN)?></p>
</div>
<div class="wrap">
			...
			<table>
				<tbody>
					<tr>
						...
						<td>
							<select data-placeholder="Please select categories" class="hcps_select" name="select_hcategory">
								<option value=""></option>
								<?php
